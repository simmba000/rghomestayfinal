  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg mb-8">
        Welcome to <span className="text-brand">RG HOMESTAY</span>, where we are
      ...
      <p className="text-lg mb-8">
        At <span className="text-brand">RG HOMESTAY</span>, we envision a world
      ...
      <ul className="list-disc ml-6 mb-8">
        <li className="text-lg mb-3">
          We offer a diverse range of ROOMS, ensuring that you find the perfect match for your
          travel style.
        </li>
        <li className="text-lg mb-3">
      ...
      <p className="text-lg mb-4">
        ...
        <a
          ...
          href="mailto:rghomestay01@gmail.com"
        >
          rghomestay01@gmail.com
        </a>
        . We're here to help!
      </p>
      <p className="text-lg">
        Thank you for choosing <span className="text-brand">RG HOMESTAY</span>.
